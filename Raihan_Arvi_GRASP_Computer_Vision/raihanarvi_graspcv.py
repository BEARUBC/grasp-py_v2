...
def determineGripTypesDependingOnWhichPartIsBlue(coordinateObject, frame):  # Works
    ...
    cv2.rectangle(
        frame,
        (int(coordinateObject[0]), int(coordinateObject[1])),
        (int(coordinateObject[2]), int(coordinateObject[3] / 2)),
        (0, 255, 255),
        6,
    )
    cv2.rectangle(
        frame,
        (int(coordinateObject[0]), int(coordinateObject[3] / 2)),
        (int(coordinateObject[2]), int(coordinateObject[3])),
        (0, 255, 255),
        6,
    )
...
def assignGripType(objectClass, objectCoordinate, frame):
    ...
    if isMultipleGripTypes(objectClass):
        grip_index = determineGripTypesDependingOnWhichPartIsBlue(
            objectCoordinate, frame
        )
